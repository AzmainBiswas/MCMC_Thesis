...
\begin{example}
	...
	from extreme left and right. If we choose an importance sampling distribution that has similar curve as $h(x)$, then we can estimate $I$ with low variance.
...
\section{Optimal Importance Sampling Distribution}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{ch4ex2plot_hx.png}
