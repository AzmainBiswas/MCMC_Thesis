...
\begin{example}[Binomial Distribution]
	...
	\begin{figure}[H]
		...
		\caption{Generating  binomial random numbers with $n=5$ and  $p=0.5$}
	\end{figure}
\end{example}
...
As $f(d,\theta)$ is equal to product of the product of $Exp(1/2)$ density and $U(0,2 \pi)$, it follows that,\\ 
